...
public class DuplicateLead2 
{
	public static void main(String[] args) throws InterruptedException 
	{
		//Open Browser
		 ...
		 //Enter Email
		 driver.findElement(By.name("emailAddress")).sendKeys("r.rajavignesh31@gmail.com");
		 ...
		 {
			 System.out.println("The title is verified as not 'Duplicate Lead'");
		 }
		 ...
		 {
			 System.out.println("The duplicated lead name is same as captured name : " + leadFirstName);
		 }
		 else
		 {
			 System.out.println("The duplicated lead name is not same as captured name : " + leadFirstName);
		 }
