...
public class EditLead 
{
	public static void main(String[] args) 
	{
		...
		WebDriverManager.chromedriver().setup();
		  ...
		  WebElement findElement16 = driver.findElement(By.linkText("Edit"));
	      findElement16.click();
	      
	      WebElement findElement17 = driver.findElement(By.id("updateLeadForm_description"));
		  findElement17.clear();
	      
		  WebElement findElement18 = driver.findElement(By.id("updateLeadForm_importantNote"));
		  findElement18.sendKeys("Test");
		  
		  WebElement findElement19 = driver.findElement(By.className("smallSubmit"));
	      findElement19.click();
